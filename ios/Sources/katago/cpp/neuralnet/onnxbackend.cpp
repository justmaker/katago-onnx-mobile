...
#else
// iOS/macOS logging using C++ iostream
#include <iostream>
#define LOGI(...) do { printf("[KataGo-ONNX] " __VA_ARGS__); printf("\n"); fflush(stdout); } while(0)
#define LOGE(...) do { fprintf(stderr, "[KataGo-ONNX ERROR] " __VA_ARGS__); fprintf(stderr, "\n"); fflush(stderr); } while(0)
#endif
